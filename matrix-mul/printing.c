...
int main(int argc, char *argv[])
{
    ...
    printers[0].jq = &job_queue;
    printers[1].jq = &job_queue;

    printers[0].id = 0;
    printers[1].id = 1;

    pthread_create(&thrd_1, NULL, printer_main, (void*) &printers[0]);
    pthread_create(&thrd_2, NULL, printer_main, (void*) &printers[1]);
